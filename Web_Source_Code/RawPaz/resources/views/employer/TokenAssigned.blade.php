...
@section('inner')
                            ...
                            <div class="dashboard_rgt">
                                ...
                                <div class="dasp_grap" >
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-12">
                                           <div class="mt-30">
                                           <a href="javascript:void(0);"  onclick="GetTokenAssigned();" class="btn btn_comm">Search</a>
                                           </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="dasp_grap" id="TokenAssigned">
                                   <!--  @foreach ($TokenAssigned as $emp)
                                        <div class="brd_btm">
            ...
            <script>
                 ...
                 function GetTokenAssigned()
                {
                    ...
                    var URL = '<?php echo route('employer.GetTokenAssigned'); ?>';
                    $.ajax({
                       type: "POST",
                       url:  URL,
                       data: DataStr,
