...
@section('inner')
                            ...
                            <div class="dashboard_rgt">
                                ...
                                <div class="dasp_grap" >
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-12">
                                           <div class="mt-30">
                                           <a href="javascript:void(0);"  onclick="GetTokenUtilization();" class="btn btn_comm">Search</a>
                                           </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="dasp_grap" id="TokenUtilization">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-md-6 col-sm-12">
                                                    <div class="frm_grp">
                                                        ...
                                                        <div class="data_txt">{{ $emp->professional }}</div>
            ...
            <script>
                ...
                function GetTokenUtilization()
                {
                    ...
                    var URL = '<?php echo route('employer.GetTokenUtilization'); ?>';
                    $.ajax({
                       type: "POST",
                       url:  URL,
                       data: DataStr,
