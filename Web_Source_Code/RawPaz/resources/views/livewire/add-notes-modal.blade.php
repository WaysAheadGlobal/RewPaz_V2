          ...
          <form wire:submit.prevent="submit('s')">
            <div class="Consultation_modal Vett_admin">
              ...
              <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-12">
                  <div class="frm_grp">
                    ...
                    <input type="text" value="{{$customerName}}" class="form-control" wire:model="customerName" placeholder="Client Name">
                  </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12">
                  <div class="frm_grp">
                  ...
                  <div class="row ">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                      <div class="frm_grp">
                        ...
                        <input type="text" wire:model="sessionDurationHr" class="form-control" placeholder="1">
                        <span class="icon">Hrs.</span>
                        @error('sessionDurationHr') <span class="text-danger error">{{ $message }}</span>@enderror
                      </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12">
                      <div class="frm_grp">
                        <label for=""></label>
                        <input type="text" wire:model="sessionDurationMin" class="form-control" placeholder="00">
                        <span class="icon">Min</span>
                        @error('sessionDurationMin') <span class="text-danger error">{{ $message }}</span>@enderror
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                  <div class="frm_grp">
                    <input type="text" wire:model="summary" class="form-control"
                      placeholder="During the online consultation with the client, we discussed their current health concerns and goals related to therapy.">
              ...
              @if ($editId)                
                @if ($advice)
                  @foreach ($advice as $key=>$val)
                    <div class="card_bx">
                      <div class="no_txt">{{$loop->iteration}}.</div>
                      <div class="frm_grp">
                        <input type="text" wire:model="advice.{{$key}}" class="form-control"
                          placeholder="Enter Advice">
                        @error('advice.{{$key}}') <span class="text-danger error">{{ $message }}</span>@enderror
                      </div>
                    </div>
                  @endforeach
                  @foreach($inputs as $key => $value)
                        <div class="card_bx">
                        <div class="no_txt">{{$key + count($advice) + 1}}</div>
                        <div class="frm_grp">
                            <input type="text" wire:model="advice.{{$key + count($advice)}}" class="form-control"
                            placeholder="Enter Advice">
                        </div>
                        </div>
                  @endforeach
              ...
              @else  
                    ...
                    <div class="card_bx">
                      <div class="no_txt">1.</div>
                      <div class="frm_grp">
                        <input type="text" wire:model="advice.1" class="form-control"
                          placeholder="Regular Yoga">
                        @error('advice.0') <span class="text-danger error">{{ $message }}</span>@enderror
                      </div>
                    </div>
                    <div class="card_bx">
                      <div class="no_txt">2.</div>
                      <div class="frm_grp">
                        <input type="text" wire:model="advice.2" class="form-control"
                          placeholder="Healthy Diet">
                      </div>
                    </div>
                    <div class="card_bx">
                      <div class="no_txt">3.</div>
                      <div class="frm_grp">
                        <input type="text" wire:model="advice.3" class="form-control"
                          placeholder="Meditation">
                      </div>
                    </div>
                    @foreach($inputs as $key => $value)
                        <div class="card_bx">
                        <div class="no_txt">{{$key + 4}}</div>
                        <div class="frm_grp">
                            <input type="text" wire:model="advice.{{$key + 4}}" class="form-control"
                            placeholder="Enter Advice">
                        </div>
                        </div>
                    @endforeach
              ...
              @endif
                   ...
                   <div class="card_bx">
                      <div class="no_txt"></div>
                      <div class="frm_grp">
                        <a href="#" wire:click.prevent="add({{$i}})">+ Add more</a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-12">
                  <div class="frm_grp">
                    ...
                    <input type="datetime-local" wire:model="followUpDate" class="form-control"
                ...
                <div class="col-lg-2 col-md-6 col-sm-12">
                  <div class="frm_grp">
                    ...
                    <input type="text" class="form-control" wire:model="followUpHr" placeholder="1">
                    <span class="icon">Hrs.</span>
                  </div>
                </div>
                <div class="col-lg-2 col-md-6 col-sm-12">
                  <div class="frm_grp">
                    <label for=""></label>
                    <input type="text" class="form-control" wire:model="followUpMin" placeholder="00">
                    <span class="icon">Min</span>
                  </div>
                </div>
                <div class="loonApplt_btn" >
                  <div class="iagt" style="justify-content: end;">
                    ...
                    <span class="agrchckmrk"></span>I agree to share the consultation notes with the care seeker</label></div>
                  </div>
                ...
                <div class="btn_grp_dash">
                  <a class="btn" style="color:#fff; background: linear-gradient(160deg, #0068C4 0%, #00A7C5 100%); color:#fff" wire:click.prevent data-bs-dismiss="modal" aria-label="Close">Back</a>
                  <button style="color:#fff; width:auto" class="btn" type="checkbox" wire:model="actiononsave" value="Save & share with Client" wire:click.prevent="submit('save and share')">Save & share with Client</button>
                </div>
              </div>
          </form>
          </div>
