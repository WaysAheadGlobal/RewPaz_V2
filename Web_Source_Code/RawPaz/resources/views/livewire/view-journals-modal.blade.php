  ...
  <div wire:ignore.self class="modal fade custom_modal" id="modalViewJournal" data-bs-backdrop="static" data-bs-keyboard="false"
    tabindex="-1" aria-labelledby="modalViewJournalLabel" aria-hidden="true">
              ...
              <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                  <div class="frm_grp">
                    ...
                    <input type="text" readonly value="{{date('d, M Y', strtotime($journalDate))}}" class="form-control" placeholder="07/07/2023">
                    <span class="icon">
                  ...
                  <div class="row ">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                      <div class="frm_grp">
                        ...
                        <input type="text" readonly value="{{date('h:i a', strtotime($journalDate))}}" class="form-control">
