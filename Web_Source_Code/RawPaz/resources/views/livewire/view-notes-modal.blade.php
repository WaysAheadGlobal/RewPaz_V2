  ...
  <div wire:ignore.self class="modal fade custom_modal" id="modalViewNote" data-bs-backdrop="static" data-bs-keyboard="false"
    tabindex="-1" aria-labelledby="modalViewNoteLabel" aria-hidden="true">
          ...
          <form wire:submit.prevent="submit('s')">
            <div class="Consultation_modal Vett_admin">
              ...
              <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                  <div class="frm_grp">
                    ...
                    <input type="text" readonly value="{{$noteDate}}" class="form-control" wire:model="dateSelected" placeholder="07/07/2023">
                    <span class="icon">
              ...
              @if($advice)
                  ...
                  @else
                   <h6 style="margin-top:-25px; margin-bottom:35px; font-size:16px; opacity:0.5">No Advice Added</h6>
                  @endif
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="btn_grp_dash">
                  <button class="btn" wire:click.prevent data-bs-dismiss="modal" aria-label="Close">Close</button>
                </div>
              </div>
          </form>
          </div>
