        ...
        <div class="Token_popup">
          ...
          <form wire:submit.prevent="submit">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="" placeholder="Please enter Meeting Link" wire:model="meetingLink"> @error('meetingLink') <span class="text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group">
              <label for="date">Username</label>
              <input type="text" class="form-control" id="" placeholder="Please enter Meeting Link" wire:model="meetingUsername"> @error('meetingUsername') <span class="text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group">
              <label for="date">Password</label>
              <input type="text" class="form-control" id="" placeholder="Please enter Meeting Link" wire:model="meetingPassword"> @error('meetingPassword') <span class="text-danger">{{ $message }}</span> @enderror
            </div>
