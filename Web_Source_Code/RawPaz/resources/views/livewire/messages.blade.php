                        ...
                        <li>
                          <div class="recvMsgs sentmsgbey d-flex">
                            <div class="cntnt sentMsgs">
                              ...
                              <div class="msgcntnt">
                              {{ $decryptionObj->decryptString($message->message) }}</div>
              ...
              <div class="chat-foot" id="chat_footer_box">
                ...
                <div class="chat-box">
                  <form name="chatform" onkeydown="scrollDown()" id="send-message" wire:submit.prevent="sendMessage">
                    <input type="text" placeholder="Write a message..." required onkeydown='scrollDown()' wire:model.defer="message"  class="msg_int_style" id="message" style="height: 32px;" />
                    <button type="submit">
...
@if(count($messages) > 0 && $role == 'Professional')
<div class="col-md-12 text-center" style="margin-top: 35px;">
  <a href="{{url('professional/create-note').'/'.$appoitmentId }}"><button class="btn btn-primary">Create Note</button></a>
</div>
@endif
</div>