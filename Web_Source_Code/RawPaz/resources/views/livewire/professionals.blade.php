<div class="anything">
@include('livewire.book-sos-appointment-modal')
    ...
    <div class="box_card_left">
      ...
      <div class="frm_grp select_icon">
        ...
        <select class="form-control">
          <option value="">--All Time Slot--</option>
          <option value="10:00 AM - 12:00 PM">10:00 AM to 12:00 PM</option>
          <option value="12:00 PM - 02:00 PM">12:00 PM to 02:00 PM </option>
          <option value="02:00 PM - 04:00 PM">02:00 PM to 04:00 PM </option>
          <option value="04:00 PM - 06:00 PM">04:00 PM to 06:00 PM </option>
          <option value="06:00 PM - 08:00 PM">06:00 PM to 08:00 PM </option>
        </select>
      </div>
      <div class="frm_grp">
        ...
        <div class="frm_gen">
         <div class="cstm_chbx">
            <label class="cstmcntr">All
            <input type="radio" value="" wire:model="filteration.gender" checked>
          ...
          <div class="cstm_chbx">
            <label class="cstmcntr">Others
            <input type="radio" value="Others" wire:model="filteration.gender">
            <span class="cstmchkmrk"></span>
            </label>
          </div>
        </div>
        ...
        <label for="">Group Session</label>
          <select class="form-control" wire:model='filteration.group_session'>
                        ...
                        <div class="rating_bx">
                           <ul>
                              <li>
                                ...
                                <?php 
                                $Rating = DB::table('feedbacks')->where('professional_id',$pro->id)->avg('rating');
                                $Review = DB::table('feedbacks')->where('professional_id',$pro->id)->count();
                           ...
                           @if($pro->is_sos_provided==1)
                           <button class="btn_appoin" wire:click="openModalForUpdate('{{$pro->user_id}}')" data-bs-toggle="modal" data-bs-target="#sos-appointment-modal">SOS Appointment</button>
                           @endif
                        </div>
