        ...
        <div class="banner_sect">
            ...
            <div class="sign_form">
                <div class="sign_scrller">
                    ...
                    <h5>Sign up</h5>
                    <p>Have an account? <a href="{{route('professional.login')}}">Login</a></p>
                    <h6>Please choose account type:</h5>
                        ...
                        <form action="{{ route('professional.sign-up') }}" method="post">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12">
                                    <div class="frm_grp">
                                        <label for="">E-mail ID<sup>*</sup> </label>
                                        <input type="email" name="email" placeholder="E-mail ID" class="form-control" value="{{old('email')}}">
                                        @error('email')
                                            <small class="text-danger">{{$message}}</small>
                                        @enderror
                                    ...
                                    <div class="loonApplt_btn">
                                        <div class="iagt">
                                            <label for="plan" class="agrtrms">
                                                ...
                                                <span class="agrchckmrk"></span>I agree with <a href="#">terms & conditions</a> and <a href="#">privacy policy</a> of RewPaz solutions Inc.
                                            </label>
                                        </div>
                                        @error('is_agree')
                                            <small class="text-danger">{{$message}}</small>
