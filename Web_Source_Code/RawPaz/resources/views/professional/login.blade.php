        ...
        <div class="banner_sect">
            ...
            <div class="sign_form">
                <div class="sign_scrller">
                    ...
                    <h5>Login</h5>
                    <p>Don’t have an account?  <a href="{{route('professional.signup')}}">Sign up</a></p>
                    <h6>Please choose account type:</h6>
                    <div class="tab_list_login">
                        <button class="btn"><a href="{{route('employer.login')}}">
                    ...
                    <form action="{{route('professional.profLogin')}}" method="post">
                        @csrf
                        <div class="row">
    ...
    <script>
        ...
        function SendOTP()
        {
            ...
            else if(phone!="")
            {
                 ...
                 {
                    $.ajax({
                      url : "{{url('/professional/SendOTP')}}"+'/'+phone,
                      type: "GET",
                      dataType: 'json',
                      data : {},
                      success:function(a){
