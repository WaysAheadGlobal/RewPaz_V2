            ...
            <div class="dasp_grap">
               <div class="Vett_admin prof_dash">
                  <div class="pof_edit_sect">
                     <div class="user_pof_edit">
                        <div class="user_bx">
                           <label for="uploadfile">
                              ...
                              <img src="{{ asset('/storage/app/upload/prof-doc/'.$result->profile_pic) }}" alt="" style="width:184px;height:184px;" >
                                @else
                                 @if ($result->gender=='Male')
                                     <img src="{{asset('assets/images/male.png')}}" alt="" style="width:184px;height:184px;" >
                                 @elseif ($result->gender=='Female')
                                     <img src="{{asset('assets/images/female.png')}}" alt="" style="width:184px;height:184px;" >
                                 @else
                                    <img src="{{asset('assets/images/others.png')}}" alt="" style="width:184px;height:184px;" >
                                 @endif
                              @endif
                                ...
                                @endif
                                 ...
                                 <div class="vidBox" id="vidBox"
                                    ...
                                    <div class="videCont" id="videCont"
                                       ...
                                       <video autoplay="" id="v1" loop=""
                                          controls="controls">
                                          <source
                                             src="https://netteria.net/myscript/jquery/html5videopopup/video/VideoPopUpHTML5.webm"
                                             type="video/webm">
                                          <source
                                             src="https://netteria.net/myscript/jquery/html5videopopup/video/VideoPopUpHTML5.mp4"
                                             type="video/mp4">
                                       </video>
                                    </div>
                                    <div class="opct" style="background: rgb(23, 33, 42);">
                                    </div>
                     ...
                     <div class="btn_grp">
                        <a class="btn" href="{{url('/professional/edit-profile')}}">Edit Profile</a>
                        ...
                        <div class="head">
                           <div class="frm_grp">
                              ...
                              <input type="text" placeholder="Leslie Alexander"
                                 class="form-control" name="name" value="{{ $result->name }}" readonly>
                           </div>
                        </div>
                        <div class="bio_sect">
                           <label for="Bio">Bio</label>
                           <div class="col-md-12 col-sm-12">
                              <textarea class="box_txt" type="text" placeholder="" readonly>{{$result->bio}}</textarea>
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="row mt-5">
                     ...
                     <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="frm_grp">
                           ...
                           <input type="text" placeholder="leslie.meditation@gmail.com" readonly name="email" value="{{$result->email}}"
                              class="form-control">
                           <span class="icon">
                     ...
                     <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="frm_grp">
                           ...
                           <input type="text" placeholder="+1 888 546 6734" name="" value=""
                              class="form-control">
                           <span class="icon">
                              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                 viewBox="0 0 24 24" fill="none">
                     ...
                     <div class="col-lg-4 col-md-6 col-sm-12">
                                                <div class="frm_grp">
                                                    ...
                                                    <input type="text" placeholder="15 Rockcliffe Blvd" class="form-control"  value="{{$result->address}}">
                                                     <span class="icon">
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-12">
                                                <div class="frm_grp">
                                                    ...
                                                    <input type="text" placeholder="M6N4P8" readonly maxlength="6" class="form-control" value="{{$result->zip_code}}">
                                                     <span class="icon">
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-12">
                                                <div class="frm_grp">
                                                    ...
                                                    <input type="text" placeholder="Master of Arts (MA)" readonly class="form-control" value="{{$result->qualification}}">
                                                     <span class="icon">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-12">
                                                <div class="frm_grp">
                                                    ...
                                                    <input type="text" placeholder="Meditation" disabled class="form-control" value="{{$result->service_offering}}">
                                                     <span class="icon">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-12">
                                                <div class="frm_grp">
                                                    ...
                                                    <div class="file_upload"><a href="{{ asset('/storage/app/upload/prof-doc/'.$result->degree_upld) }}" target="_blank"><span style="font-size: 17px;">{{$result->degree_upld}}</span></a>
                                                    </div>
                                                    <span class="icon">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-12">
                                                <div class="frm_grp">
                                                    ...
                                                    <input type="text" placeholder="https://facebook.com/lesile" readonly class="form-control" value="{{$result->facebook_link}}">
                                                     <span class="icon">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-12">
                                                <div class="frm_grp">
                                                    ...
                                                    <input type="text" placeholder="https://linkedin.com/lesile" readonly class="form-control" value="{{$result->linkedin_link}}">
                                                     <span class="icon">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                            <path d="M12.8947 17.4713C13.0352 17.6119 13.1142 17.8026 13.1142 18.0014C13.1142 18.2002 13.0352 18.3909 12.8947 18.5316L11.9628 19.4691C10.9773 20.4539 9.64094 21.007 8.24769 21.0065C6.85444 21.0061 5.51843 20.4522 4.53356 19.4667C3.5487 18.4812 2.99565 17.1449 2.99609 15.7516C2.99653 14.3584 3.55042 13.0224 4.53591 12.0375L6.79716 9.77626C7.74374 8.82892 9.01657 8.27914 10.3552 8.2394C11.6938 8.19967 12.997 8.67299 
 10.4638 14.1273 10.5499 14.0618 10.6238C13.9963 10.6976 13.9169 10.7579 13.8282 10.8011C13.7394 10.8442 13.643 10.8695 13.5444 10.8754C13.4459 10.8813 13.3471 10.8678 13.2538 10.8356C13.1605 10.8033 13.0745 10.753 13.0006 10.6875C12.2856 10.0525 11.355 9.71473 10.3992 9.74313C9.44333 9.77153 8.53446 10.164 7.85841 10.8403L5.59716 13.0988C4.89375 13.8022 4.49859 14.7562 4.49859 15.7509C4.49859 16.7457 4.89375 17.6997 5.59716 18.4031C6.30056 19.1065 7.25458 19.5017 8.24934 19.5017C9.24411 19.5017 10.1981 19.1065 10.9015 18.4031L11.8334 17.4713C11.9031 17.4015 11.9858 17.3462 12.0768 17.3085C12.1679 17.2707 12.2655 17.2513 12.364 17.2513C12.4626 17.2513 12.5602 17.2707 12.6512 17.3085C12.7423 17.3462 12.825 17.4015 12.8947 17.4713ZM19.4647 4.53376C18.479 3.55034 17.1435 2.99805 15.7512 2.99805C14.3589 2.99805 13.0234 3.55034 12.0378 4.53376L11.1059 5.46657C10.9653 5.6073 10.8864 5.79813 10.8864 5.99706C10.8865 6.196 10.9656 6.38675 11.1064 6.52736C11.2471 6.66796 11.4379 6.7469 11.6369 6.74682C11.8358 6.74673 12.0266 6.66762 12.1672 6.52689L13.099 5.59501C13.8024 4.89161 14.7565 4.49644 15.7512 4.49644C16.746 4.49644 17.7 4.89161 18.4034 5.59501C19.1068 6.29842 19.502 7.25244 19.502 8.2472C19.502 9.24196 19.1068 10.196 18.4034 10.8994L16.1422 13.1625C15.4657 13.8384 14.5567 14.2304 13.6008 14.2583C12.645 14.2862 11.7146 13.9478 11 13.3125C10.8508 13.1802 10.6552 13.1126 10.4561 13.1246C10.2571 13.1365 10.071 13.2271 9.93872 13.3763C9.80644 13.5254 9.73885 13.7211 9.7508 13.9201C9.76276 14.1191 9.85329 14.3052 10.0025 14.4375C11.0033 15.3273 12.3064 15.8009 13.645 15.7615C14.9836 15.7222 16.2566 15.1727 17.2034 14.2256L19.4647 11.9644C20.4487 10.9787 21.0013 9.6428 21.0013 8.25001C21.0013 6.85722 20.4487 5.52134 19.4647 4.53564V4.53376Z" fill="#515151"/>
                                                          </svg>
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-12">
                                                <div class="frm_grp">
                                                    ...
                                                    @endphp
                                                    @foreach ($lang as $ln)
                                                        <span class="form-control">{{ $ln }}</span>
                                                    @endforeach
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-12">
                                                <div class="frm_grp">
                                                    ...
                                                    <div class="file_upload"><a href="{{ asset('/storage/app/upload/prof-doc/'.$result->photo_id_upld) }}" target="_blank"><span style="font-size: 17px;">{{$result->photo_id_upld}}</span></a>
</div>
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-12">
                                                <div class="frm_grp">
                                                    ...
                                                    <select class="form-control" name="is_sos_provided" disabled>
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-12">
                                                <div class="frm_grp">
                                                    ...
                                                    <input type="text" placeholder="100.00" readonly class="form-control" value="{{$result->group_session_fee}}" name="group_session_fee">
                                                     <span class="icon">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                            <path d="M15 14L12 12V7M3 12C3 13.1819 3.23279 14.3522 3.68508 15.4442C4.13738 16.5361 4.80031 17.5282 5.63604 18.364C6.47177 19.1997 7.46392 19.8626 8.55585 20.3149C9.64778 20.7672 10.8181 21 12 21C13.1819 21 14.3522 20.7672 15.4442 20.3149C16.5361 19.8626 17.5282 19.1997 18.364 18.364C19.1997 17.5282 19.8626 16.5361 20.3149 15.4442C20.7672 14.3522 21 13.1819 21 12C21 10.8181 20.7672 9.64778 20.3149 8.55585C19.8626 7.46392 19.1997 6.47177 18.364 5.63604C17.5282 4.80031 16.5361 4.13738 15.4442 3.68508C14.3522 3.23279 13.1819 3 12 3C10.8181 3 9.64778 3.23279 8.55585 3.68508C7.46392 4.13738 6.47177 4.80031 5.63604 5.63604C4.80031 6.47177 4.13738 7.46392 3.68508 8.55585C3.23279 9.64778 3 10.8181 3 12Z" stroke="#515151" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                                          </svg>
                     ...
                     <div class="slot_list_sect">
                        ...
                        @foreach ($daysArr as $day)
                            ...
                            <div class="slot_select selected">
                                <input type="checkbox" name="availability_days[]" value="" id="{{ $day }}" class="custom-control-input" {{ $checked }}>
                  ...
                  <div class="time_slot_sect">
                    ...
                    if($timeSelected == $time){
                        ...
                        <div class="slot_select selected">
                            <input type="checkbox" name="availability_time[]" id="{{ $time }}" class="custom-control-input" {{ $checked1 }}>
