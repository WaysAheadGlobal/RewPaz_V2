   ...
   <div class="row" id="proBanner">
      <div class="col-sm-12">
         <div class="dashboard_rgt">
            ...
            @endif
            <form action="{{route('professional.UpdateProfile')}}" method="post" enctype="multipart/form-data">
               @csrf
                  ...
                  <div class="Vett_admin prof_dash">
                        ...
                        <div class="user_pof_edit">
                           ...
                           <div class="user_bx">
                              ...
                              <label for="uploadfile">
                                 ...
                                 <img src="{{ asset('/storage/app/upload/prof-doc/'.$result->profile_pic) }}" alt="" style="width:184px;height:184px;" id="preview">
                                   @else
                                    @if ($result->gender=='Male')
                                        <img src="{{asset('assets/images/male.png')}}" alt="" style="width:184px;height:184px;" id="preview">
                                    @elseif ($result->gender=='Female')
                                        <img src="{{asset('assets/images/female.png')}}" alt="" style="width:184px;height:184px;" id="preview">
                                    @else
                                       <img src="{{asset('assets/images/others.png')}}" alt="" style="width:184px;height:184px;" id="preview">
                                    @endif
                                 @endif
                           ...
                           <div class="bx_prof">
                                    ...
                                    <div class="vidBox" id="vidBox"
                                       ...
                                       <div class="videCont" id="videCont" style="z-index: 100002;">
                                          <video autoplay="" id="v1" loop="" controls="controls">
                                             <source
                                                src="{{ asset('/storage/app/upload/prof-doc/'.$result->profile_video) }}"
                                                type="video/webm">
                                             <source
                                                src="{{ asset('/storage/app/upload/prof-doc/'.$result->profile_video) }}">
                                          </video>
                              ...
                              <div class="btn_grp">
                                 <a class="btn uplo_video" href="javascript:void(0)">
                                    <input type="file" name="profile_video" id="profile_video" class="upload_video">
                                    <label for="profile_video">Replace</label>
                                 </a>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="bio_detail">
                           <div class="head">
                              <div class="frm_grp">
                                 ...
                                 <input type="text" placeholder="Leslie Alexander"
                                    class="form-control" name="name" value="{{ $result->name }}" >
                              </div>
                           </div>
                           <div class="bio_sect">
                              <label for="Bio">Bio</label>
                              <div class="col-md-12 col-sm-12">
                                 <textarea class="box_txt" name="bio" type="text" placeholder="" >{{$result->bio}}</textarea>
                              </div>
                           </div>
                        </div>
                     </div>
                     <div class="row mt-5">
                        <div class="col-lg-4 col-md-6 col-sm-12">
                           <div class="frm_grp">
                              <label for="">DOB</label>
                              <input type="text" placeholder="10/06/1990" class="form-control" id="datepicker" name="dob"  value="{{$result->dob}}">
                              <!--<input type="date" placeholder="Leslie Alexander" name="dob" value="{{$result->dob}}"
                                 class="form-control" >-->
                               <span class="icon">
                                 <svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <g clip-path="url(#clip0_743_8867)">
                                       <path
                                          ...
                                          fill="#515151" />
                                       <path
                                          d="M5.33398 9.33203H6.66732V10.6654H5.33398V9.33203Z"
                                          fill="#515151" />
                                       <path
                                          d="M9.33398 9.33203H10.6673V10.6654H9.33398V9.33203Z"
                                          fill="#515151" />
                                       <path
                                          d="M13.334 9.33203H14.6673V10.6654H13.334V9.33203Z"
                                          fill="#515151" />
                                       <path
                                          d="M17.334 9.33203H18.6673V10.6654H17.334V9.33203Z"
                                          fill="#515151" />
                                       <path
                                          d="M5.33398 12.668H6.66732V14.0013H5.33398V12.668Z"
                                          fill="#515151" />
                                       <path
                                          d="M9.33398 12.668H10.6673V14.0013H9.33398V12.668Z"
                                          fill="#515151" />
                                       <path d="M13.334 12.668H14.6673V14.0013H13.334V12.668Z"
                                          fill="#515151" />
                                       <path d="M17.334 12.668H18.6673V14.0013H17.334V12.668Z"
                                          fill="#515151" />
                                       <path d="M5.33301 16H6.66634V17.3333H5.33301V16Z"
                                          fill="#515151" />
                                       <path d="M9.33301 16H10.6663V17.3333H9.33301V16Z"
                                          fill="#515151" />
                                       <path d="M13.333 16H14.6663V17.3333H13.333V16Z"
                                          fill="#515151" />
                                       <path d="M17.333 16H18.6663V17.3333H17.333V16Z"
                                          fill="#515151" />
                                       <path
                                          d="M6.66667 6.66536C6.84348 6.66536 7.01305 6.59513 7.13807 6.4701C7.2631 6.34508 7.33333 6.17551 7.33333 5.9987V1.9987C7.33333 1.82189 7.2631 1.65232 7.13807 1.52729C7.01305 1.40227 6.84348 1.33203 6.66667 1.33203C6.48986 1.33203 6.32029 1.40227 6.19526 1.52729C6.07024 1.65232 6 1.82189 6 1.9987V5.9987C6 6.17551 6.07024 6.34508 6.19526 6.4701C6.32029 6.59513 6.48986 6.66536 6.66667 6.66536Z"
                                          fill="#515151" />
                                       <path
                                          d="M17.3327 6.66536C17.5095 6.66536 17.6791 6.59513 17.8041 6.4701C17.9291 6.34508 17.9993 6.17551 17.9993 5.9987V1.9987C17.9993 1.82189 17.9291 1.65232 17.8041 1.52729C17.6791 1.40227 17.5095 1.33203 17.3327 1.33203C17.1559 1.33203 16.9863 1.40227 16.8613 1.52729C16.7363 1.65232 16.666 1.82189 16.666 1.9987V5.9987C16.666 6.17551 16.7363 6.34508 16.8613 6.4701C16.9863 6.59513 17.1559 6.66536 17.3327 6.66536Z"
                                          fill="#515151" />
                                       <path d="M8.66699 4H15.3337V5.33333H8.66699V4Z"
                                          fill="#515151" />
                                    </g>
                                    <defs>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                           <div class="frm_grp">
                              ...
                              <input type="text" placeholder="leslie.meditation@gmail.com"  name="email" value="{{$result->email}}"
                                 class="form-control">
                              <span class="icon">
                           ...
                           <div class="frm_grp select_icon">
                              ...
                              <select class="form-control" name="gender" >
                                   ...
                                   <option value="">--please select--</option>
                                    ...
                                    <option value="Others" {{ ( 'Others' == $result->gender ) ? 'selected' : '' }}>Others</option>
                              </select>
                           </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12">
                           <div class="frm_grp">
                               ...
                               <input type="text" placeholder="15 Rockcliffe Blvd" class="form-control"  value="{{$result->address}}" name="address">
                                <span class="icon">
                       ...
                       <div class="col-lg-4 col-md-6 col-sm-12">
                           <div class="frm_grp">
                               ...
                               <input type="text" placeholder="M6N4P8"  maxlength="6" class="form-control" value="{{$result->zip_code}}" name="zip_code">
                                <span class="icon">
                       ...
                       <div class="col-lg-4 col-md-6 col-sm-12">
                           <div class="frm_grp">
                               ...
                               <input type="text" placeholder="Master of Arts (MA)"  class="form-control" name="qualification" value="{{$result->qualification}}">
                                <span class="icon">
                                   <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                       ...
                       <div class="col-lg-4 col-md-6 col-sm-12">
                           <div class="frm_grp">
                               ...
                               <select class="form-control"  name="expertise" >
                                   ...
                                   <option value="Physical Wellness" {{ ( 'Physical Wellness' == $result->expertise) ? 'selected' : '' }}>Physical Wellness</option>
                                   <option value="Mental Wellness" {{ ( 'Mental Wellness' == $result->expertise ) ? 'selected' : '' }}>Mental Wellness</option>
                       ...
                       <div class="col-lg-4 col-md-6 col-sm-12">
                           <div class="frm_grp">
                               ...
                               <input type="text" placeholder="Meditation"  class="form-control" value="{{$result->service_offering}}" name="service_offering">
                                <span class="icon">
                                   <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                       ...
                       <div class="col-lg-4 col-md-6 col-sm-12">
                           <div class="frm_grp">
                               ...
                               <br><a href="{{ asset('/storage/app/upload/prof-doc/'.$result->degree_upld) }}" target="_blank"><span style="font-size: 17px;">Clik To View Old</span></a>
                                <span class="icon">
                                   <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                               ...
                               <input type="file" placeholder="Phd Degree.pdf" class="form-control" value="" name="degree_uplda">
                           </div>
                       ...
                       <div class="col-lg-4 col-md-6 col-sm-12">
                           <div class="frm_grp">
                               ...
                               <input type="text" placeholder="https://facebook.com/lesile"  class="form-control" name="facebook_link" value="{{$result->facebook_link}}">
                                <span class="icon">
                                   <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                       ...
                       <div class="col-lg-4 col-md-6 col-sm-12">
                           <div class="frm_grp">
                               ...
                               <input type="text" placeholder="https://linkedin.com/lesile"  class="form-control" name="linkedin_link" value="{{$result->linkedin_link}}">
                                <span class="icon">
                                   <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                       <path d="M12.8947 17.4713C13.0352 17.6119 13.1142 17.8026 13.1142 18.0014C13.1142 18.2002 13.0352 18.3909 12.8947 18.5316L11.9628 19.4691C10.9773 20.4539 9.64094 21.007 8.24769 21.0065C6.85444 21.0061 5.51843 20.4522 4.53356 19.4667C3.5487 18.4812 2.99565 17.1449 2.99609 15.7516C2.99653 14.3584 3.55042 13.0224 4.53591 12.0375L6.79716 9.77626C7.74374 8.82892 9.01657 8.27914 10.3552 8.2394C11.6938 8.19967 12.997 8.67299 13.9981 9.56251C14.072 9.62801 14.1322 9.70741 14.1754 9.79619C14.2186 9.88497 14.2438 9.98139 14.2498 10.0799C14.2557 10.1785 14.2421 10.2772 14.2099 10.3705C14.1776 10.4638 14.1273 10.5499 14.0618 10.6238C13.9963 10.6976 13.9169 10.7579 13.8282 10.8011C13.7394 10.8442 13.643 10.8695 13.5444 10.8754C13.4459 10.8813 13.3471 10.8678 13.2538 10.8356C13.1605 10.8033 13.0745 10.753 13.0006 10.6875C12.2856 10.0525 11.355 9.71473 10.3992 9.74313C9.44333 9.77153 8.53446 10.164 7.85841 10.8403L5.59716 13.0988C4.89375 13.8022 4.49859 14.7562 4.49859 15.7509C4.49859 16.7457 4.89375 17.6997 5.59716 18.4031C6.30056 19.1065 7.25458 19.5017 8.24934 19.5017C9.24411 19.5017 10.1981 19.1065 10.9015 18.4031L11.8334 17.4713C11.9031 17.4015 11.9858 17.3462 12.0768 17.3085C12.1679 17.2707 12.2655 17.2513 12.364 17.2513C12.4626 17.2513 12.5602 17.2707 12.6512 17.3085C12.7423 17.3462 12.825 17.4015 12.8947 17.4713ZM19.4647 4.53376C18.479 3.55034 17.1435 2.99805 15.7512 2.99805C14.3589 2.99805 13.0234 3.55034 12.0378 4.53376L11.1059 5.46657C10.9653 5.6073 10.8864 5.79813 10.8864 5.99706C10.8865 6.196 10.9656 6.38675 11.1064 6.52736C11.2471 6.66796 11.4379 6.7469 11.6369 6.74682C11.8358 6.74673 12.0266 6.66762 12.1672 6.52689L13.099 5.59501C13.8024 4.89161 14.7565 4.49644 15.7512 4.49644C16.746 4.49644 17.7 4.89161 18.4034 5.59501C19.1068 6.29842 19.502 7.25244 19.502 8.2472C19.502 9.24196 19.1068 10.196 18.4034 10.8994L16.1422 13.1625C15.4657 13.8384 14.5567 14.2304 13.6008 14.2583C12.645 14.2862 11.7146 13.9478 11 13.3125C10.8508 13.1802 10.6552 13.1126 10.4561 13.1246C10.2571 13.1365 10.071 13.2271 9.93872 13.3763C9.80644 13.5254 9.73885 13.7211 9.7508 13.9201C9.76276 14.1191 9.85329 14.3052 10.0025 14.4375C11.0033 15.3273 12.3064 15.8009 13.645 15.7615C14.9836 15.7222 16.2566 15.1727 17.2034 14.2256L19.4647 11.9644C20.4487 10.9787 21.0013 9.6428 21.0013 8.25001C21.0013 6.85722 20.4487 5.52134 19.4647 4.53564V4.53376Z" fill="#515151"/>
                                     </svg>
                       ...
                       <div class="col-lg-4 col-md-6 col-sm-12">
                           <div class="frm_grp">
                               ...
                               <input type="text" placeholder
                                     </svg>
                       ...
                       <div class="col-lg-4 col-md-6 col-sm-12">
                           <div class="frm_grp">
                               ...
                               <input type="text" placeholder="100.00" class="form-control" value="{{$result->hourly_fees}}">
                                <span class="icon">
                                   <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                       ...
                       <div class="col-lg-4 col-md-6 col-sm-12">
                           <div class="frm_grp">
                               <label for="">Add language*</label><br>
                               @php
                                   $lang=EXPLODE(',',$result->language);
                                   //print_r($lang);
                               @endphp
                               <!-- @foreach ($lang as $ln)
                                   <span style="font-size: 16px;color: #fff;background-color: #232323;">{{ $ln }}</span>
                               @endforeach -->
                       ...
                       <div class="col-lg-4 col-md-6 col-sm-12">
                           <div class="frm_grp">
                              ...
                              @if($result->photo_id_upld!='')
                               <a href="{{ asset('/storage/app/upload/prof-doc/'.$result->photo_id_upld) }}" target="_blank"><span style="font-size: 17px;">Clik To View Old</span></a>
                               @endif
                              <div class="upload_btn">
                              <input type="file" placeholder="Meditation Certificate" class="form-control" value="" name="photo_id_upld" id="photo_id_upld">
                              <label for="photo_id_upld">UPLOAD</label>
                              </div>
                                <span class="icon">
                                   <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                       ...
                       <div class="col-lg-4 col-md-6 col-sm-12">
                           <div class="frm_grp">
                               ...
                               <div class="file_upload">
                              <a href="{{ asset('/storage/app/upload/prof-doc/'.$result->certification_upld) }}" target="_blank"><span style="font-size: 17px;">Clik To View Old</span></a>
                              <div class="upload_btn">
                              <input type="file" placeholder="Meditation Certificate" class="form-control" value="" name="certification_upld">
                              <label for="photo_id_upld">UPLOAD</label>
                              </div>
                               </div>
                                <span class="icon">
                       ...
                       <div class="col-lg-4 col-md-6 col-sm-12">
                           <div class="frm_grp">
                               ...
                               <select class="form-control" name="is_group_session_provided" >
                                   <option value="">--Please Select--</option>
                                   <option value="1" {{ ( '1' == $result->is_group_session_provided ) ? 'selected' : '' }}>Yes</option>
                                   <option value="0" {{ ( '0' == $result->is_group_session_provided ) ? 'selected' : '' }}>No</option>
                       ...
                       <div class="col-lg-4 col-md-6 col-sm-12">
                           <div class="frm_grp">
                               <label for="">Do You Provide SOS</label>
                               <select class="form-control" name="is_sos_provided" >
                                   <option value="0" {{ ( '0' == $result->is_sos_provided ) ? 'selected' : '' }}>No</option>
                                   <option value="1" {{ ( '1' == $result->is_sos_provided ) ? 'selected' : '' }}>Yes</option>
                               </select>
                           </div>
                       ...
                       <div class="col-lg-4 col-md-6 col-sm-12">
                           <div class="frm_grp">
                               ...
                               <input type="text" placeholder="100.00"  class="form-control" value="{{$result->group_session_fee}}" name="group_session_fee">
                                <span class="icon">
                                   <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                       <path d="M15 14L12 12V7M3 12C3 13.1819 3.23279 14.3522 3.68508 15.4442C4.13738 16.5361 4.80031 17.5282 5.63604 18.364C6.47177 19.1997 7.46392 19.8626 8.55585 20.3149C9.64778 20.7672 10.8181 21 12 21C13.1819 21 14.3522 20.7672 15.4442 20.3149C16.5361 19.8626 17.5282 19.1997 18.364 18.364C19.1997 17.5282 19.8626 16.5361 20.3149 15.4442C20.7672 14.3522 21 13.1819 21 12C21 10.8181 20.7672 9.64778 20.3149 8.55585C19.8626 7.46392 19.1997 6.47177 18.364 5.63604C17.5282 4.80031 16.5361 4.13738 15.4442 3.68508C14.3522 3.23279 13.1819 3 12 3C10.8181 3 9.64778 3.23279 8.55585 3.68508C7.46392 4.13738 6.47177 4.80031 5.63604 5.63604C4.80031 6.47177 4.13738 7.46392 3.68508 8.55585C3.23279 9.64778 3 10.8181 3 12Z" stroke="#515151" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                     </svg>
                     ...
                     <div class="slot_date_sect">
                        ...
                        @foreach ($daysArr as $day)
                            ...
                            <div class="slot_select selected">
                                <input type="checkbox" name="availability_days[]"  id="{{ $day }}" class="custom-control-input" {{ $checked }} value="{{ $day }}">
                    ...
                    if($timeSelected == $time){
                        ...
                        <div class="slot_select selected">
                            <input type="checkbox" name="availability_time[]" id="{{ $time }}" class="custom-control-input" {{ $checked1 }} value="{{ $time }}">
                            <label for="{{ $time }}">{{ $time }}</label>
                        </div>
                    @endforeach
                  </div>
                     <div class="btn_grp_dash">
                        <!-- <button class="btn" type="button">Delete Account</button> -->
                     </div>
                  </div>
               </div>
            </form>
