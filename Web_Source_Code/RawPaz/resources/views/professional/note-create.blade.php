...
<div class="notemainhlder">
    @php
      ...
      $data = ['serviceSeeker' => $serviceSeeker, 'serviceProvider' => $appointment->professional_id, 'customerName' => $appointment->name, 'appoitmentId' => $appointment->uid];
    @endphp
    @livewire('professional-notes', compact('data'))
</div>
