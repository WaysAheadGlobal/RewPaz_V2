            ...
            <div class="box_card_rgt">
               <div class="head_search">
                  <div class="resul_txt">
                     ...
                     <h4>{{ $res }} profiles based on your search criteria</h4>
               ...
               <div class="prof_list" id="search_data">

                @foreach ($prof as $pro)
                <div class="card_bx" id="total_records">
                     <div class="img_bx">
                     ...
                     <div class="cont_bx">
                        ...
                        <div class="Speci_sect">
                           ...
                           <button class="btn_more">Know more</button>
                        </div>
                     </div>
                  </div>
                     ...
                     <div class="cont_bx">
                        ...
                        <div class="Speci_sect">
                           <p>
                              ...
                              <span>Specialty: Meditation </span>
                           </p>
                           <p>
                              <span>
                                 <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
