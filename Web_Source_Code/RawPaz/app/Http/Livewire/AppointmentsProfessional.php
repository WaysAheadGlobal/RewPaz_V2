...
public function __construct() {
    ...
    public function updateStatus($status, $uuid)
    {
        ...
        if($update){
            ...
            if($tokenUsedCreate){
                ...
                $this->SendSMS($AppointmentId,$AppStatus);
                ///////////////////////
    ...
    public function SendSMS($AppointmentId,$AppStatus)
    {
        $appointmentData    =  Appointment::where('id', $AppointmentId)->first();
        $professionalData   =  User::where('id', $appointmentData->professional_id)->first();
        $userData           =  User::where('id', $appointmentData->created_by)->first();

        $RecipientName = $userData->name;
        $RecipientPhone = $userData->c_code.$userData->phone;
        $ProfessionalName = $professionalData->name;
        $AppointmentDate = $appointmentData->appointmentDate;
        $AppointmentTime = $appointmentData->appointment_timing;
        ...
        $message = "Hello ".$RecipientName.", This is a confirmation that your appointment is ".$AppStatus." with ".$ProfessionalName." on ".$AppointmentDate." at ".$AppointmentTime." . Team Rawpaz"; 
